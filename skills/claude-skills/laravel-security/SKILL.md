...
## When to use laravel-security vs alternatives

| Situation | Use |
|---|---|
| You are changing Laravel auth, policies, validation, uploads, rate limiting, cookies, or secret handling | `laravel-security` |
| You need Laravel architecture or Eloquent guidance | `laravel-patterns` |
