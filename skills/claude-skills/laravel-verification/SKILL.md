...
## When to use laravel-verification vs alternatives

| Situation | Use |
|---|---|
| You need the final Laravel-specific gate across env, static analysis, tests, security, and deploy readiness | `laravel-verification` |
| You are still writing or fixing Laravel behavior test-first | `laravel-tdd` |
| You need Laravel architecture guidance | `laravel-patterns` |
| You need a generic fallback for non-Laravel stacks | `verification-loop` |
