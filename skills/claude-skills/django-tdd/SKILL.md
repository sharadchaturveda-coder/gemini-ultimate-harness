...
## When to use django-tdd vs alternatives

| Situation | Use |
|---|---|
| You are implementing or fixing Django behavior test-first with pytest, factory_boy, and DRF tests | `django-tdd` |
| You need Django architecture or implementation patterns outside test design | `django-patterns` |
| You are running a final validation pass rather than writing tests first | `django-verification` |
| You need a generic fallback for non-Django stacks | `tdd-workflow` |
