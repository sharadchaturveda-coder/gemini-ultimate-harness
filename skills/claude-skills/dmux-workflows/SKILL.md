...
## When to use dmux-workflows vs alternatives

| Situation | Use |
|---|---|
| You want parallel panes across mixed harnesses like Claude Code, Codex, OpenCode, or Gemini | `dmux-workflows` |
| You need Claude-native worktree missions and structured reports via a server | `claude-devfleet` |
| You want to choose and compose agent personas before dispatch | `team-builder` |
| You need the abstract loop pattern rather than a tmux runtime | `continuous-agent-loop` |
