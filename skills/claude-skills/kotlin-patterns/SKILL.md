...
## When to use kotlin-patterns vs alternatives

| Situation | Use |
|---|---|
| You need language-level Kotlin guidance: nullability, immutability, data classes, sealed types, DSLs, and general module design | `kotlin-patterns` |
| The work is mainly coroutine, Flow, or concurrency behavior | `kotlin-coroutines-flows` |
| The work is mainly Ktor server design | `kotlin-ktor-patterns` |
| The work is mainly Exposed ORM and database access | `kotlin-exposed-patterns` |
| The work is mainly test design in Kotlin | `kotlin-testing` |
