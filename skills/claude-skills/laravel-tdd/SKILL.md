...
## When to use laravel-tdd vs alternatives

| Situation | Use |
|---|---|
| You are implementing or fixing Laravel behavior test-first with Pest/PHPUnit, factories, and feature tests | `laravel-tdd` |
| You need Laravel architecture guidance outside testing | `laravel-patterns` |
| You need a final verification pass rather than test-first implementation | `laravel-verification` |
| You need a generic fallback for non-Laravel stacks | `tdd-workflow` |
