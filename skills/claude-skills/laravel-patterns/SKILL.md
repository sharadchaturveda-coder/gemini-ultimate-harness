...
## When to use laravel-patterns vs alternatives

| Situation | Use |
|---|---|
| You are designing Laravel controllers, services, Eloquent models, queues, events, caching, or API resources | `laravel-patterns` |
| You are reviewing auth, validation, uploads, secrets, rate limiting, or deployment hardening in Laravel | `laravel-security` |
| You are implementing Laravel behavior test-first | `laravel-tdd` |
| You are running final Laravel release gates | `laravel-verification` |
