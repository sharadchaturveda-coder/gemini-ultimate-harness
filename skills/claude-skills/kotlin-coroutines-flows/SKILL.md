...
## When to use kotlin-coroutines-flows vs alternatives

| Situation | Use |
|---|---|
| The main problem is coroutine structure, cancellation, Flow/StateFlow/SharedFlow, or async testing | `kotlin-coroutines-flows` |
| You need broader Kotlin language and module design guidance | `kotlin-patterns` |
| You are primarily building Ktor server endpoints and plugins | `kotlin-ktor-patterns` |
| You are primarily designing Exposed queries and DB transactions | `kotlin-exposed-patterns` |
