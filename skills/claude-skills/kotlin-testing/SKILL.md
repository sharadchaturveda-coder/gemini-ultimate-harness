...
## When to use kotlin-testing vs alternatives

| Situation | Use |
|---|---|
| You need Kotlin test design, Kotest/MockK patterns, coroutine testing, or coverage guidance | `kotlin-testing` |
| The main problem is Ktor server implementation rather than tests | `kotlin-ktor-patterns` |
| The main problem is Exposed ORM and DB transaction design rather than tests | `kotlin-exposed-patterns` |
| You need broader language-level Kotlin guidance | `kotlin-patterns` |
| You need a generic fallback for non-Kotlin stacks | `tdd-workflow` |
