...
## When to use kotlin-ktor-patterns vs alternatives

| Situation | Use |
|---|---|
| You are building Ktor routes, plugins, auth, serialization, DI, WebSockets, or `testApplication` tests | `kotlin-ktor-patterns` |
| You need broader Kotlin language conventions | `kotlin-patterns` |
| The main issue is coroutine/Flow behavior outside Ktor server design | `kotlin-coroutines-flows` |
| The main issue is Exposed ORM and repository design | `kotlin-exposed-patterns` |
