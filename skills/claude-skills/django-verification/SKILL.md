...
## When to use django-verification vs alternatives

| Situation | Use |
|---|---|
| You need the final Django-specific gate across migrations, lint, tests, deploy checks, and security review | `django-verification` |
| You are still implementing test-first Django behavior | `django-tdd` |
| You need general Django design guidance | `django-patterns` |
| You need a generic fallback for non-Django stacks | `verification-loop` |
