...
## When to use kotlin-exposed-patterns vs alternatives

| Situation | Use |
|---|---|
| You are designing Exposed DSL/DAO queries, transactions, HikariCP config, Flyway migrations, or repository patterns | `kotlin-exposed-patterns` |
| You need broader Kotlin language conventions | `kotlin-patterns` |
| The main issue is coroutine/Flow coordination rather than persistence | `kotlin-coroutines-flows` |
| The main issue is Ktor server routing and plugins rather than persistence | `kotlin-ktor-patterns` |
