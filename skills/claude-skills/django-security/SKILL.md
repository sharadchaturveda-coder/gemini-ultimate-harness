...
## When to use django-security vs alternatives

| Situation | Use |
|---|---|
| You are changing Django auth, permissions, cookies, CSRF, headers, secrets, or deployment hardening | `django-security` |
| You need general Django architecture or DRF design guidance | `django-patterns` |
