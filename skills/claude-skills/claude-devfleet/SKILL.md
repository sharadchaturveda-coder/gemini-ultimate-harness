...
## When to use claude-devfleet vs alternatives

| Situation | Use |
|---|---|
| You need isolated worktrees, mission DAGs, structured reports, and Claude-native multi-agent dispatch | `claude-devfleet` |
| You want tmux-pane coordination across mixed harnesses, not a DevFleet server | `dmux-workflows` |
| You want help picking agent personas before dispatch | `team-builder` |
| You need an RFC decomposition pattern independent of runtime | `ralphinho-rfc-pipeline` |
| You need the general operating model for AI-assisted engineering | `agentic-engineering` |
