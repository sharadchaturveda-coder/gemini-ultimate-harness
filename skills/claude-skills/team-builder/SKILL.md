...
## When to use team-builder vs alternatives

| Situation | Use |
|---|---|
| You need to browse available agent personas and choose a team before execution | `team-builder` |
| You already know the missions and want Claude-native worktree execution | `claude-devfleet` |
| You already know the prompts and want pane-based parallel work across harnesses | `dmux-workflows` |
| You need an execution DAG from an RFC rather than persona selection | `ralphinho-rfc-pipeline` |
